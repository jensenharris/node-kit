 ...
 */
function Kit(str, variables, forbiddenPaths, templatePath) {
...
Kit.prototype._findFile = function(filePath) {
    ...
    var overridePath = path.resolve(this._templatePath + '/' + filePath);

    lookupPaths.push(overridePath);
    lookupPaths.push(path.join(this._fileDir, overridePath));
